...
public class CompressedInputStream extends InputStream
{
    ...
    /* FRED*/
    static boolean headerRead = false;
     ...
     * @throws IOException
     */
    public CompressedInputStream(InputStream input) throws IOException {
        this.in = input;
/*FRED        readHeader(); */
    }
    ...
    protected void readHeader() throws IOException {
        ...
        if (codec.isValidMagicHeader()) {
            // The input data is compressed by CompressedOutputStream
    ...
    protected boolean hasNextChunk() throws IOException {
        ...
        int chunkSize = CompressedOutputStream.readInt(chunkSizeBuf, 0);
